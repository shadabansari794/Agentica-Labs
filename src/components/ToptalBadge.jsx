// Toptal Badge Component
export default function ToptalBadge() {
    return (
        <div id="r" className="inline-block animate-scale-in" style={{ animationDelay: '0.5s' }}>
            <style>{`
        ...
        .a{width:200px;padding:24px 0 40px;display:flex;flex-direction:column;align-items:center;gap:8px;color:#204ecf;text-align:center;background:radial-gradient(circle at 20% -10%,#00c3ff -80%,#fff 30%),radial-gradient(circle at -20% 20%,#00c3ff -80%,#fff 30%),radial-gradient(circle at 70% 100%,#00c3ff -80%,#fff 30%),radial-gradient(circle at 120% 80%,#00c3ff -80%,#fff 30%);background-blend-mode:multiply;clip-path:var(--h);box-shadow:0 28px 50px rgba(6,30,96,.35)}
        ...
        .d{font-size:16px;margin-bottom:-6px}
        ...
        .f:hover{background:#1e56e0;transform:scale(1.05);transition:all 0.3s}
      `}</style>
            <div className="h">
                <div className="a">
                    ...
                    <a className="f" href="https://www.toptal.com/developers/resume/shadab-arif-ansari#onxEdj" target="_blank" rel="noopener noreferrer">Hire me</a>
                </div>
            </div>
        </div>
    );
